...
describe "AFM fonts" do
  ...
  it "should calculate string width taking into account accented characters" do
    @times.compute_width_of(@iconv.iconv("Ž"), :size => 12).should == @times.compute_width_of("e", :size => 12)
  end
  ...
  it "should calculate string width taking into account kerning pairs" do
    ...
    @times.compute_width_of(@iconv.iconv("Tš"), :size => 12, :kerning => true).should == 12.372
  end

  it "should encode text without kerning by default" do
    @times.encode_text(@iconv.iconv("To")).should == [[0, "To"]]
    @times.encode_text(@iconv.iconv("TŽlŽ")).should == [[0, @iconv.iconv("TŽlŽ")]]
  ...
  it "should encode text with kerning if requested" do
    ...
    @times.encode_text(@iconv.iconv("TŽlŽ"), :kerning => true).should == [[0, ["T", 70, @iconv.iconv("ŽlŽ")]]]
...
describe "TTF fonts" do
  ...
  it "should calculate string width taking into account accented characters" do
    @activa.compute_width_of("Ž", :size => 12).should == @activa.compute_width_of("e", :size => 12)
  end
  ...
  it "should encode text without kerning by default" do
    ...
    @activa.encode_text("TŽlŽ").should == [[0, "T\216l\216"]]
    @activa.encode_text("Technology").should == [[0, "Technology"]]
    @activa.encode_text("Technology...").should == [[0, "Technology..."]]
    @activa.encode_text("Te?nology...").should == [[0, "Te"], [1, "!"], [0, "nology..."]]
  end
  ...
  it "should encode text with kerning if requested" do
    ...
    @activa.encode_text("Te?nology...", :kerning => true).should == [[0, ["T", 186.0, "e"]], [1, "!"], [0, ["nology", 88.0, "..."]]]
  end
