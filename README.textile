...
Eggs has been rolled out to two farms, but a lot of things are still missing UI pieces and all features are built specifically for those two farms - a more general use case will require some tweaking, at the very least.
